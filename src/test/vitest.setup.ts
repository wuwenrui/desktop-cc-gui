  ...
  useTranslation: () => ({
    t: (key: string, params?: Record<string, unknown>) => {
      ...
      const translations: Record<string, string> = {
        ...
        "settings.sidebarAdvancedFeatures": "Advanced Features",
        ...
        "settings.runtimeEnvironmentDependenciesTab": "Dependencies",
        "settings.runtimeEnvironmentWeChatBridgeTab": "WeChat",
        "settings.advancedFeaturesDescription":
          "Manage advanced capabilities that require a subscription or extra account key.",
        ...
        "settings.wechatBridgeAccountConfigured": `Configured from ${String(params?.source ?? "")} · ${String(params?.token ?? "")}`,
        "settings.wechatBridgeAccountMissing":
          "Configure the model-site key for subscription and entitlement checks. This does not switch Claude providers.",
        ...
        "settings.wechatBridgeAccountTokenConfigured": "Configured",
        ...
        "settings.wechatBridgeRebindRecoverySent":
          "Verification code sent to the bound WeChat.",
        ...
        "settings.wechatBridgeSendProbeConfirm":
          "Send a verification message to the WeChat account used for scan?",
        "settings.wechatBridgeProbeSent":
          "Verification message sent. Reply from WeChat in that chat.",
        "settings.wechatBridgeBoundReady":
          "WeChat is already bound. Send verification to that chat.",
        "settings.wechatBridgeBoundMissing":
          "No bound WeChat account found. Rebind WeChat and scan again.",
        "settings.wechatBridgeQrTitle": "Scan login",
        "settings.wechatBridgeBoundaryTitle": "Use boundary",
        "settings.wechatBridgeBoundaryText":
          "Text, voice, images, files, and quoted messages are forwarded to the desktop agent.",
        "settings.wechatBridgeBoundaryRisk":
        ...
        "settings.wechatBridgeVerificationWaiting":
          "Waiting for the test message after scan.",
        "settings.wechatBridgeVerificationSmokeOnly":
          "Local self-check passed. Real WeChat check is still pending.",
        "settings.wechatBridgeVerificationPassed":
          "Verified: real WeChat message reached the app and got a reply.",
        "settings.wechatBridgeVerificationNeedsAction":
          "Real WeChat message reached the app, but the reply did not complete.",
