const enPart1 = {
  ...
  messages: {
    ...
    visionPreflightRunning: "{{skill}} is analyzing images…",
    visionPreflightRunningMeta: "{{model}} · {{count}} image(s)",
    visionPreflightDone: "{{skill}} analysis complete",
    visionPreflightDoneMeta: "Extracted ~{{chars}} chars · {{seconds}}s",
    visionPreflightFailed: "{{skill}} analysis failed",
