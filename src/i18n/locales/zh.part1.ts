const zhPart1 = {
  ...
  messages: {
    ...
    visionPreflightRunning: "{{skill}} 正在解析图片…",
    visionPreflightRunningMeta: "{{model}} · {{count}} 张图片",
    visionPreflightDone: "{{skill}} 解析完成",
    visionPreflightDoneMeta: "提取约 {{chars}} 字 · 用时 {{seconds}} 秒",
    visionPreflightFailed: "{{skill}} 解析失败",
